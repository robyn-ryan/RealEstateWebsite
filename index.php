...
<div class="container-lg">
    <h3>Who Are We?</h3>
    <p align="justify">We are a small local business established in 2022 that specialises in residential and commercial buying and selling. 
...
<?php 
require "connect.php";
//sort by most recent date added and limit properties displayed to 4
$sql="SELECT * FROM property ORDER BY dateadded desc limit 4";
$result=mysqli_query($link, $sql);
//$sqlall="SELECT * FROM property ORDER BY dateadded desc";
...
echo "<div class='card-footer text-center bg-white border-0'>";
echo "<a class='btn btn-primary' 
href='moredetails.php?propertyid=$propertyid'>Details</a>";
echo "</div>";
echo "</div>"; // card-body
echo "</div>"; // card
echo "</div>"; // column
